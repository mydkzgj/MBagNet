...
def create_supervised_trainer(model, optimizers, metrics, loss_fn, device=None,):
    ...
    def _update(engine, batch):
        ...
        weight = {"cross_entropy_multilabel_loss":1, "cross_entropy_loss":1, "seg_mask_loss":1, "gcam_mask_loss":1, "pos_masked_img_loss":0.2, "neg_masked_img_loss":1, "for_show_loss":0}
        gl_weight = [1, 1, 1, 1]
        loss = 0
