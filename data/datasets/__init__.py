...
from data.datasets.lib.ddr import DDR_DR_GRADING, DDR_LESION_SEGMENTATION, DDR_LESION_SEGMENTATION_MULTILABEL_WEAKSURPERVISION, DDR_LESION_SEGMENTATION_MULTILABEL_WEAKSURPERVISION_COLORMASK
