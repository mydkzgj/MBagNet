...
class VisualExamples(BaseImageDataset):
    """
    Market1501
    Reference:
    ...
    """
    dataset_dir = 'DATABASE/examples'

    def __init__(self, root='/home/haoluo/data', verbose=True, **kwargs):
        super(VisualExamples, self).__init__()
        ...
        classes, idx_to_wnid, wnid_to_classes = parse_meta_mat("D:\MIP\Experiment\MBagNet\data\DATABASE\examples\ILSVRC2012_devkit_t12")
