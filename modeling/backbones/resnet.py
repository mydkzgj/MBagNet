...
__all__ = ['ResNet', 'resnetS224', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
...
# CJY 依据BasicBlock进行的修改，将第一个卷积由3*3变为1*1
...
def resnetS224(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet2('resnetS224', BasicBlock2, [4, 4, 4], pretrained, progress,
                   **kwargs)